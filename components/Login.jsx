        ...
        <div className="bg-gray-300 w-[100%] h-[100vh] flex justify-between">
            <div className="ml-2 sm:ml-12 mt-48">
                ...
                <div className="flex lg:flex-row flex-col gap-9 md:gap-16 mt-12 ">
                    <button className="box-border relative z-30 inline-flex items-center justify-center m-2 w-auto px-8 py-3 overflow-hidden font-bold text-white transition-all duration-300 bg-brock-blue rounded-md cursor-pointer group ring-offset-2 ring-1 ring-indigo-300 ring-offset-gray-100 hover:ring-offset-gray-200 ease focus:outline-none ">
